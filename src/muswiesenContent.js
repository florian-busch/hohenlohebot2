//define dates for muswiese 2022, 2023 and todays date
...
calculateTimeToMuswiese = () => {
  ...
  if (new Date().getFullYear() == 2022 && new Date() < new Date(Date.UTC(2022, 9, 8))) {
    return muswiese22.getTime() - today.getTime();
  //if year == 2023 and muswiese from 2022 has ended
  } else if (new Date().getFullYear() == 2023 && new Date() > new Date(Date.UTC(2022, 9, 13))) {
